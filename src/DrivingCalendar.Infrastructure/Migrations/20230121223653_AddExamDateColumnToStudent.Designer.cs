...
namespace DrivingCalendar.Infrastructure.Migrations
{
    ...
    [Migration("20230121223653_AddExamDateColumnToStudent")]
    partial class AddExamDateColumnToStudent
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DrivingCalendar.Business.Models.ApplicationRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DrivingCalendar.Infrastructure.Entities.AvailabilityEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DrivingCalendar.Infrastructure.Entities.DrivingLessonEntity", b =>
                {
                    b.HasOne("DrivingCalendar.Business.Models.Instructor", "Instructor")
                        .WithMany()
                        .HasForeignKey("InstructorId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("DrivingCalendar.Business.Models.Student", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("DrivingCalendar.Business.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DrivingCalendar.Business.Models.Student", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser<int>", null)
                        .WithOne()
                        .HasForeignKey("DrivingCalendar.Business.Models.Student", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
